...
<div class="plugin-card-grid" data-plugin-grid>
  ...
  <a class="plugin-card" href="oobrowser/" data-category="extensions" data-search="oobrowser extensions browser chromium mcef dns pin web">
    <div class="plugin-card-top"><img src="../assets/branding/oobrowser/logo-1024.png" alt="OOBrowser Logo" loading="lazy" decoding="async"><span class="plugin-state state-planned">Paused · Unreleased</span></div>
